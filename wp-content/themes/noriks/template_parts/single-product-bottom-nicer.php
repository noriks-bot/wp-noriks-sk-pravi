...
<section  style="background: white;" class="why-section">
  <div class="container why-container">
    ...
    <!-- Left Video -->
    <div class="why-col">
       <img src="https://noriks.com/sk/wp-content/uploads/2026/02/prednosti-in-lastnosti2_sk.png">
    </div>
...
if ( has_term( array( 'boxerky', 'orto-boxerky', 'bokserice-sastavi-paket' ), 'product_cat', get_the_ID() ) ) {
