...
require_once plugin_dir_path( __FILE__ ) . 'Fixtures/Crawlers.php';
require_once plugin_dir_path( __FILE__ ) . 'Fixtures/Exclusions.php';
require_once plugin_dir_path( __FILE__ ) . 'Fixtures/Headers.php';
