...
<div class="xoo-wsc-slider">
	...
	<?php if( $showSaveLater ): ?>
		...
		<div class="xoo-wsc-sl-content xoo-wsc-sl-savelater"  data-slider="savelater">

			<?php do_action( 'xoo_wsc_slider_savelater_start' ); ?>

			<?php xoo_wsc_helper()->get_template( 'global/slider/save-for-later.php' ); ?>

			<?php do_action( 'xoo_wsc_slider_savelater_end' ); ?>
